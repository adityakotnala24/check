...
import { GroundWaterSourceFormType } from "./GroundWaterSourceForm";

export interface FormInputHolderProps {
  formData: GroundWaterSourceFormType;
  setFormData: React.Dispatch<React.SetStateAction<GroundWaterSourceFormType>>;
}

interface GenericDropdownProps {
  formData: GroundWaterSourceFormType;
  setFormData: React.Dispatch<React.SetStateAction<GroundWaterSourceFormType>>;
  keyName: keyof GroundWaterSourceFormType;
  label: string;
  endpoint: string;
  dependencyKey?: keyof GroundWaterSourceFormType;
}
...
export const ActivitiesListDropdown = (props: FormInputHolderProps) => (
  <GenericDropdown
    ...
    keyName="activity"
    label="Activity"
    endpoint="get-activity.php?activityType=GroundWater" />
);